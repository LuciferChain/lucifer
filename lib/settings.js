...
exports.wallet = {
  ...
  "host": "localhost",
  // port: The port # that the wallet is configured to listen for RPC requests on (default: 51573 for wLUC wallet)
  "port": 51573,
...
exports.shared_pages = {
  ...
  //        Valid options: Cerulean, Cosmo, Cyborg, Darkly, wLUC, Flatly, Journal, Litera, Lumen, Lux, Materia, Minty, Morph, Pulse, Quartz, Sandstone, Simplex, Sketchy, Slate, Solar, Spacelab, Superhero, United, Vapor, Yeti, Zephyr
...
exports.richlist_page = {
  ...
  "burned_coins": {
    ...
    "addresses": [ "wLUCBurnAddressXXXXXXXXXXXXXW7cDZQ" ],
